package cn.edu.hbmy.search.controller.system.login;
...
import cn.edu.hbmy.search.entity.system.User;
import cn.edu.hbmy.search.services.system.user.UserService;
...
import cn.edu.hbmy.search.entity.system.Menu;
...
import cn.edu.hbmy.search.util.RightsHelper;
		...
		if(null != KEYDATA && KEYDATA.length == 3){
			...
			if(null == code || "".equals(code)){
				...
				if(Tools.notEmpty(sessionCode) && sessionCode.equalsIgnoreCase(code)){
					...
					System.out.println("mima:"+passwd);//密码加密
